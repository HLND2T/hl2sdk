...
if not IS_LINUX:
    sys.stderr.write("WARNING: Negative compilation tests are not supported on this platform")
    sys.exit(0)
...
TEST_SPECS = [
    ("MOCK_METHOD_INVALID_CONST_SPEC", [r"onst cannot be recognized as a valid specification modifier"]),
]
