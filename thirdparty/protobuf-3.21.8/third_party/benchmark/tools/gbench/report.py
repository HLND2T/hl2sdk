...
def color_format(use_color, fmt_str, *args, **kwargs):
    ...
    if not use_color:
        ...
        kwargs = {key: arg if not isinstance(arg, BenchmarkColor) else BC_NONE for key, arg in kwargs.items()}
...
def generate_difference_report(json1, json2, use_color=True):
    ...
    first_line = "{:<{}s}     Time           CPU           Old           New".format("Benchmark", first_col_width)
