...
class UnexpectedMethodCallError(Error):
    ...
    def __str__(self):
        return "Unexpected method call: %s.  Expecting: %s" % (self._unexpected_method, self._expected)
...
class Mox(object):
    ...
    _USE_MOCK_OBJECT = [types.ClassType, types.InstanceType, types.ModuleType, types.ObjectType, types.TypeType]
