...
public:
	...
	virtual void unk_301( const void *const msg ) = 0;		// 52
	virtual void unk_302( const void *const msg ) = 0;		// 53

	virtual void unk_303( const void *const msg ) = 0;		// 54
	virtual void unk_304( const void *const msg ) = 0;		// 55
